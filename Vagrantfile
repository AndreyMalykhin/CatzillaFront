...
Vagrant.configure(2) do |config|
  ...
  config.vm.provider "virtualbox" do |provider, override|
    ...
    override.vm.provision :shell, path: provisionFile, args: [projectDir, "dev", environmentVars['port'], environmentVars['virtual_machine']['host']]

    provider.name = "catzilla_front"
  ...
  config.vm.provider :digital_ocean do |provider, override|
    ...
    override.vm.provision :shell, path: provisionFile, args: [projectDir, "prod", environmentVars['port'], environmentVars['digital_ocean']['host']]
